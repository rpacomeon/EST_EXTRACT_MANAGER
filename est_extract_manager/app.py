...
def main():
    ...
    with st.sidebar:
        ...
        master_list_path = st.text_input(
            ...
            help="Master_Config_List.xlsx 파일 경로"
        )
        st.session_state.master_list_path = master_list_path.strip() if master_list_path else master_list_path
        ...
        watch_folder = st.text_input(
            ...
            help="새 로그 파일을 감시할 폴더"
        )
        st.session_state.watch_folder = watch_folder.strip() if watch_folder else watch_folder
        ...
        st.session_state.output_folder = output_folder.strip() if output_folder else output_folder
